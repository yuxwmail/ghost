 ...
 */
public abstract class AbstractGHostPlatformTransactionManager implements PlatformTransactionManager, Serializable {
        ...
        if (isValidateExistingTransaction()) {
            if (definition.getIsolationLevel() != TransactionDefinition.ISOLATION_DEFAULT) {
                ...
                if (currentIsolationLevel == null || currentIsolationLevel.intValue() != definition.getIsolationLevel()) {
                    ...
                    //by reflect get constants
                    Constants isoConstants = null;
                    try {
                        Class clazz =  DefaultTransactionDefinition.class.getClass();
                        Field  field = clazz.getField("constants");
                        field.setAccessible(true);
                        isoConstants = (Constants)field.get(clazz);
                    } catch (Exception e) {
                        isoConstants = new Constants(TransactionDefinition.class);
                    }

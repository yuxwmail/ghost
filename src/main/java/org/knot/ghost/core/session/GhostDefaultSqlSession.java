...
public class GhostDefaultSqlSession implements SqlSession {
    ...
    public GhostDefaultSqlSession(Configuration configuration, Executor executor, boolean autoCommit){

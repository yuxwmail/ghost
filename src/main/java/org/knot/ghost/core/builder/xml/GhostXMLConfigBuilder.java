package org.knot.ghost.core.builder.xml;
...
/**
 * GhostXMLConfigBuilder
 * 
 * @author <a href="mailto:yuxwmail@gmail.com">yuxiaowei</a>
 */
public class GhostXMLConfigBuilder extends BaseBuilder {

	  private boolean parsed;
	  private XPathParser parser;
	  private String environment;

	  public GhostXMLConfigBuilder(Reader reader) {
	    this(reader, null, null);
	  }
	  
	  public GhostXMLConfigBuilder(Reader reader, String environment) {
	    this(reader, environment, null);
	  }

	  public GhostXMLConfigBuilder(Reader reader, String environment, Properties props) {
	    this(new XPathParser(reader, true, props, new XMLMapperEntityResolver()), environment, props);
	  }
	  
	  public GhostXMLConfigBuilder(InputStream inputStream) {
	    this(inputStream, null, null);
	  }

	  public GhostXMLConfigBuilder(InputStream inputStream, String environment) {
	    this(inputStream, environment, null);
	  }

	  public GhostXMLConfigBuilder(InputStream inputStream, String environment, Properties props) {
	    this(new XPathParser(inputStream, true, props, new XMLMapperEntityResolver()), environment, props);
	  }
	  
	  private GhostXMLConfigBuilder(XPathParser parser, String environment, Properties props) {
	    super(new GhostConfiguration());

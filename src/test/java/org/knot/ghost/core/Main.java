...
import org.knot.ghost.core.service.AccountService;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Account acount = new Account(); //datasource1 account1 acount.setUsername("11"); Account a =
         * service.getAccount(acount); System.out.println("username:" + a.getUsername()); //datasource1 account
         * acount.setUsername("2"); a = service.getAccount(acount); System.out.println("username:" + a.getUsername());
         * //datasource2 account1 acount.setUsername("13"); a =service.getAccount(acount);
         * System.out.println("username:" + a.getUsername());
         */
